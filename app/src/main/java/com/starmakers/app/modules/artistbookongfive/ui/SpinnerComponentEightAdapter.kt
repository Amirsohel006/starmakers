...
class SpinnerComponentEightAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerComponentEightModel>
) : ArrayAdapter<SpinnerComponentEightModel>(mContext, layoutResource, allItems) {
