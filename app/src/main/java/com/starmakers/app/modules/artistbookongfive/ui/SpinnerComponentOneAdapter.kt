...
class SpinnerComponentOneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerComponentOneModel>
) : ArrayAdapter<SpinnerComponentOneModel>(mContext, layoutResource, allItems) {
