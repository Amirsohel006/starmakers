...
class SpinnerComponentSevenAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerComponentSevenModel>
) : ArrayAdapter<SpinnerComponentSevenModel>(mContext, layoutResource, allItems) {
